...
function genTable(word, patterns) {
    ...
    for (patIndex in patterns) {
        ...
        if (ch != "") table += "<br>" + ch + ' '
        if (source.startsWith("cam")) table += "<a href='https://dictionary.cambridge.org/zht/搜索/english-chinese-traditional/direct/?q=" + word.toLowerCase() + "' target='blank_'><span class='glyphicon glyphicon-book'></span></a>"
